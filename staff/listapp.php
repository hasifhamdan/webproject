          ...
          <div id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                ...
                <li  class="nav-item active"><a class="nav-link" href="../staff/listapp.php"> &nbsp;  &nbsp;  &nbsp;  &nbsp;List Appointment</a></li>
      ...
      <div class="col-9" style="background-color: white; text-align: center;">
        <div class="container">
          ...
          <div class="row col-lg-12">
            <div class="col-lg-3"><a href="../staff/staffhome.php"><-Back Home</a></div><div class="col-lg-9"><h4>List Of Appointment</h4></div><div class="col-lg-3" style="text-align:right"><!-- <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#myModal">Add Staff</button> --></div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
                ...
                <td><button  onclick="myFunction()" type="button" class="btn btn-warning">Delete</button></td>
                </tr>
                <?php
              }
                ?>
