          ...
          <!-- <form method="post">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
               ...
               $sql2="SELECT * FROM orderlist WHERE orderid = '$id' AND name='$name'";
               $result2=mysqli_query($conn,$sql2);

               $total= "SELECT SUM(`price`) AS total FROM orderlist WHERE orderid='$id' AND name='$name'";
              ...
              <tr style="background-color:cyan">
                ...
                <td><h2>Rm <?php   echo $row['total'];?></h2></td>
              </tr>
            </tbody>
          </table>
