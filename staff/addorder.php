    ...
    <div class="row">
      ...
      <div class="col-9" style="background-color: white; text-align: center;">
        <div class="container">
          ...
          <div class="col-lg-3"><a href="../staff/staffhome.php"><-Back Home</a></div><div class="col-lg-9"><h4>Add Order</h4></div><div class="col-lg-3" style="text-align:right"><!-- <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#myModal">Add Staff</button> --></div>
          ...
          <form>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <input id="cusname" name="textinput" type="text" placeholder="CUSTOMER's NAME" class="form-control input-md">
              </div>
              <div class="col-md-2"></div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2"></div>
              <div class="col-md-8">
                <input id="noic" name="textinput" type="text" placeholder="NO - IC" class="form-control input-md">
              </div>
              <div class="col-md-2"></div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2"></div>
              <div class="col-md-8">
                <input id="address" name="textinput" type="text" placeholder="ADDRESS" class="form-control input-md">
              </div>
              <div class="col-md-2"></div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2"></div>
              <div class="col-md-8">
                <input id="notel" name="textinput" type="text" placeholder="No - TEL" class="form-control input-md">
              </div>
              <div class="col-md-2"></div>
            </div>
