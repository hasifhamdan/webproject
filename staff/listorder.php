      ...
      <div class="col-10" style="background-color: white; text-align: center;">
        <div class="container">
          ...
          <div class="row col-lg-12">
            <div class="col-lg-3"><a href="../staff/staffhome.php"><-Back Home</a></div><div class="col-lg-9"><h4>List Of Order</h4></div><div class="col-lg-3" style="text-align:right"><!-- <button type="button" class="btn btn-warning"  data-toggle="modal" data-target="#myModal">Add Staff</button> --></div>
          ...
          <div class="row col-lg-12">
           ...
           <div class="col-md-8">
            <input id="seacrh" name="seacrh" type="text" placeholder="PRODUCT NAME" class="form-control input-md">
          </div>
          <div class="col-md-2">
          <button name="btnS" type="submit" class="btn btn-warning">Seacrh</button>
        </div>
        <div class="col-md-2"></div></div></form>
        <br>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
           ...
           if(isset($_POST['btnS'])){
            $a = $_POST['seacrh'];
             $sql2="SELECT * FROM `order` WHERE name='$a'";
           $result2=mysqli_query($conn,$sql2);
           }
           ...
           while ($row2=mysqli_fetch_assoc($result2)) {   
             ...
             <tr>
              ...
              <td>Rm <?php echo $row2['address']   ?></td>
              <td>Rm <?php echo $row2['notel']   ?></td>
              <td>Rm <?php echo $row2['email']   ?></td>


              <td><a type="button" class="btn btn-warning" href="orderuser.php?id=<?php echo $row2['orderid'] ?>&nameuser=<?php echo $row2['name'] ?>">View</a></td>
            </tr>
